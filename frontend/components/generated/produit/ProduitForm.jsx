...
export default function ProduitForm({ uid }) {
    ...
    useEffect(() => {
        ...
        ProduitService.detailsEntity(uid)
			...
			form.setFieldValue("prix", details.prix);
			form.setFieldValue("enStock", details.enStock);
...
// POST SUCCESS
    ...
    return (
        <div className={FormStyle.page}>
            ...
            {renderFormItem("prix", "Prix", true, "number", "Prix")}
          {renderCheckBoxFormItem("enStock", "En Stock", true, "number", "En Stock")}
{/*Form*/}
                    </div>
                </FormSection>
