...
import LifecycleHistoryTimeline from "@/components/common/lifecycle/LifecycleHistoryTimeline";//IMPORT

const EDIT_URL = "/generated/commande/edit/";

export default function CommandeDetailsDrawer({
                                                 isVisible,
                                                 hideDetails,
                                                 drawerTitle,
                                                 selectedElement,
                ...
                <div className={ds.body}>
                    <div className={ds.section}>
                        <span className={ds.section_label}>Informations</span>
                                   <DrawerFieldRow label="Date Commande" value={el.dateCommande}/>
           <DrawerFieldRow label="Montant Total" value={el.montantTotal}/>
{/*drawer_form*/}
                    </div>
