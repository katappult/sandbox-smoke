    ...
    async function updatePassword() {
        ...
        if(responseSuccess(response)) {
            ...
            notification.success({
                message: t("my_account.password_updated"),
                description: t("reset_password.success_desc"),
            });
        }
        else {
            notification.error({
                message: t("my_account.password_update_error"),
                description: t("my_account.password_update_error_desc"),
            });
        }
    }
            ...
            <div className={SetPassword.container}>
                <div className={SetPassword.wrapper}>
                    <div className={SetPassword.content}>
                        <p>{t("my_account.password_desc")}</p>
