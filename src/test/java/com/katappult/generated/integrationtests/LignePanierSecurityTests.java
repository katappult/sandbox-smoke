...
/**
 * Teste les règles de sécurité (@PreAuthorize) de LignePanierGeneratedServiceFacade
 ...
 */
class LignePanierSecurityTests extends AbstractGeneratedTests {

    private static final String ROOT = "ligne_panier";
