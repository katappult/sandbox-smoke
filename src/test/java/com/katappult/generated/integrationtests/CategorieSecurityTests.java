...
/**
 * Teste les règles de sécurité (@PreAuthorize) de CategorieGeneratedServiceFacade
 ...
 */
class CategorieSecurityTests extends AbstractGeneratedTests {

    private static final String ROOT = "categorie";
