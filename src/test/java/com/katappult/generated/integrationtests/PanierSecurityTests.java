...
/**
 * Teste les règles de sécurité (@PreAuthorize) de PanierGeneratedServiceFacade
 ...
 */
class PanierSecurityTests extends AbstractGeneratedTests {

    private static final String ROOT = "panier";
