...
/**
 * Teste les règles de sécurité (@PreAuthorize) de LigneCommandeGeneratedServiceFacade
 ...
 */
class LigneCommandeSecurityTests extends AbstractGeneratedTests {

    private static final String ROOT = "ligne_commande";
