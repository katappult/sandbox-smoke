...
/**
 * Teste les règles de sécurité (@PreAuthorize) de CommandeGeneratedServiceFacade
 ...
 */
class CommandeSecurityTests extends AbstractGeneratedTests {

    private static final String ROOT = "commande";
