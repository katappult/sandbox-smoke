...
@Getter
@Setter
public class LigneCommandeRestResponse extends AbstractResponse{
    ...
    public LigneCommandeRestResponse(){

    }

    @JsonIgnore
    public LigneCommandeRestResponse populateFromEntity(Persistable entity) {
