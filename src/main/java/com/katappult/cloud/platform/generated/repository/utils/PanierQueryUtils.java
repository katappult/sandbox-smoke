...
public class PanierQueryUtils {
    ...
    public static BooleanExpression search(PanierQuerySpec querySpec, QPanier entity){
        ...
        if(Objects.nonNull(querySpec.getDateCreationMin())){
            whereClause = whereClause.and(entity.dateCreation.goe(querySpec.getDateCreationMin()));
        }
        if(Objects.nonNull(querySpec.getDateCreationMax())){
            whereClause = whereClause.and(entity.dateCreation.loe(querySpec.getDateCreationMax()));
        }
