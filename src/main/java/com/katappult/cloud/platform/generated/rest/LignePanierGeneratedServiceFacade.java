...
import com.katappult.cloud.platform.generated.model.queryspec.LignePanierQuerySpec;
...
@io.swagger.v3.oas.annotations.tags.Tag(name = "LignePanier", description = "Manages LignePanier and its relations. ")
@SecurityRequirement(name = "bearerAuth")
@RestController
@RequestMapping("ligne_panier")
public class LignePanierGeneratedServiceFacade extends BaseKatappultRestService {

    private final ILignePanierService service;
    private final IPersistableService persistableService;
    private final Provider<UIAttributes> uiAttributesProvider;

    public LignePanierGeneratedServiceFacade(ILignePanierService service, IPersistableService persistableService,
   ...
   @Operation(summary = "Create LignePanier",
                  description = "Creates a new LignePanier."
   ...
   @ApiResponses({
       @ApiResponse(responseCode = "200", description = "Entity created successfully",
                    content = @Content(schema = @Schema(implementation = LignePanierRestResponse.class))),
       @ApiResponse(responseCode = "200", description = "Validation error — response body contains error messages",
                    content = @Content(schema = @Schema(implementation = LignePanierRestResponse.class)))
   })
   @PostMapping
   @Transactional(propagation = Propagation.REQUIRES_NEW)
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'CREATE_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public LignePanierRestResponse create(@RequestBody LignePanierRestRequest request) {
...
// ENRICH CREATE ENDPOINT
       LignePanier created = service.create(uiAttributes);

       return response.populateFromEntity(created);
   }


   @Operation(summary = "Get LignePanier details", description = "Returns the full data of the entity.")
   @ApiResponses({
   ...
   @GetMapping("/{uid}")
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'READ_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public LignePanierRestResponse details(
       ...
       LignePanierRestResponse response = new LignePanierRestResponse();
       LignePanier entity = getPersistable(uid, LignePanier.class);
       return response.populateFromEntity(entity);
   }


   @Operation(summary = "Bulk delete LignePanier",
   ...
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'DELETE_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN') or hasRole('ROLE_ADMIN')")
   public SuccessRestResponse deleteElements(@RequestBody DeleteRequest request) {
       ...
       for (int i = 0; i < request.getIdentifiers().size(); i++) {
           ...
           Persistable object = getPersistable(uid, LignePanier.class);
           toDelete.add(object);
       }
   ...
   @DeleteMapping("/{uid}")
   @Transactional(propagation = Propagation.REQUIRES_NEW)
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'DELETE_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   ...
   @PatchMapping("/{uid}")
   @Transactional(propagation = Propagation.REQUIRES_NEW)
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'UPDATE_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public LignePanierRestResponse patch(
       ...
       return new LignePanierRestResponse().populateFromEntity(entity);
   }
   ...
   @Transactional(propagation = Propagation.REQUIRES_NEW)
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'UPDATE_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public LignePanierRestResponse update(
           @Parameter(description = "Uid identifier", required = true)
           @PathVariable(name = "uid") final String uid,
           @RequestBody LignePanierRestRequest request) {
       ...
       LignePanier updated = service.update(uiAttributes);
   ...
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'LIST_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public ListRestResponse<LignePanierListRestModel> list(
       ...
       if (StringUtils.isNotBlank(searchTerm)) {
           LignePanierQuerySpec querySpec = new LignePanierQuerySpec();
   ...
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'SEARCH_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public ListRestResponse<LignePanierListRestModel> listFromUids(
       ...
       var list = identifiers.stream()
               .map(uid -> getPersistable(uid, LignePanier.class))
               .toList();
       return new ListRestResponse<>(list, LignePanierListRestModel.class);
   }


   @Operation(summary = "Advanced search",
              description = "Paginated search using a `LignePanierQuerySpec` body. "
   ...
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'SEARCH_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public ListRestResponse<LignePanierListRestModel> advancedSearch(@RequestBody LignePanierQuerySpec querySpec) {
   ...
   @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'SEARCH_LIGNEPANIER') or hasRole('ROLE_SUPERADMIN')")
   public ListRestResponse<LignePanierListRestModel> search(
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'READ_LIGNEPANIER')")
  public ListRestResponse<LignePanierListRestModel> listItemsOfProduit(
  ...
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Entity found",
                   content = @Content(schema = @Schema(implementation = LignePanier.class))),
      @ApiResponse(responseCode = "404", description = "No Entity found for this element")
  })
  @GetMapping(value = "/singleItemOfProduit")
  @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'READ_LIGNEPANIER')")
  public LignePanierRestResponse singleItemOfProduit(
          @Parameter(description = "Encoded identifier of the user (Produit)", required = true) @RequestParam("produitUid") String produitUid) {
      Produit produit = getPersistable(produitUid, Produit.class);
      LignePanier entity = service.getSingleItemOfProduit(produit);
      return new LignePanierRestResponse().populateFromEntity(entity);
  }
  ...
  @Transactional(propagation = Propagation.REQUIRES_NEW)
  @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'UPDATE_LIGNEPANIER')")
  public LignePanierRestResponse setManyToOneProduit(
  ...
  @Transactional(propagation = Propagation.REQUIRES_NEW)
  @PreAuthorize("hasAnyAuthority('ADMIN_ENTITY_LIGNEPANIER', 'DELETE_LIGNEPANIER')")
