...
public class QCategorie extends EntityPathBase<Categorie> {
    ...
    public static final QCategorie categorie = new QCategorie("entity");
...
private QCategorie parent;
    private ListPath<Categorie, QCategorie> children;
    ...
    public QCategorie parent() {
        if (parent == null) {
            parent = new QCategorie(forProperty("parent"));
        }

        return parent;
    }

    public ListPath<Categorie, QCategorie> children() {
        if (children == null) {
            children = createList("children", Categorie.class, QCategorie.class, PathInits.DIRECT2);
        }
